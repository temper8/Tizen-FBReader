...
std::string ZLTizenFSManager::convertFilenameToUtf8(const std::string &name) const {
	/*if (name.empty()) {
		return name;
	}
...
/*
std::string ZLTizenFSManager::mimeType(const std::string &path) const {
	std::string type;
...
shared_ptr<ZLMimeType> ZLTizenFSManager::mimeType(const std::string &path) const {
	// TODO: implement
